...
def calc_Eks(ko, ki, nao, nai, pKNa, RTONF):
    ...
    return RTONF * log((ko + pKNa * nao) / (ki + pKNa * nai))
...
def calc_tau_j(u):
    ...
    beta_j = calc_where(u >= -40., 0.6*exp(-2.535e-7*u) / (1+exp(-0.1*(u+32))),
